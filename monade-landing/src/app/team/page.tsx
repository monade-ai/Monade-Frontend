        ...
        <div className="team-grid">
          <div className="team-member">
            ...
            <div className="social-links">
              <a href="https://www.linkedin.com/in/narayan-thakur-b63b55281/" target="_blank" rel="noopener noreferrer">LinkedIn</a> |{" "}
              <a href="https://x.com/thakurnarayan49" target="_blank" rel="noopener noreferrer">Twitter</a>
            </div>
          </div>
          <div className="team-member">
            ...
            <p>Amol Soans</p>
            <div className="social-links">
              <a href="https://www.linkedin.com/in/amoldericksoans/" target="_blank" rel="noopener noreferrer">LinkedIn</a> |{" "}
              <a href="https://x.com/AmolSoans" target="_blank" rel="noopener noreferrer">Twitter</a>
            </div>
          </div>
          <div className="team-member">
